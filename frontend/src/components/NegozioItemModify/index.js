...
const NegoziotemModify = ({reservation}) => {
        ...
        <Container>
            <Row>
                ...
                <Col
                    ...
                    <Button className="w-100 h-100 p-3 mb-2 bg-link text-white border-success"> Modifica </Button>
                </Col>
...
export default NegoziotemModify;